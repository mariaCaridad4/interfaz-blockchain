...
function createData(na, titulo, datos) {
    if (nivelacceso <= na){
        return {
            titulo,
            datos
...
const rows = [
    createData(1,'Datos del Paciente y Motivos de la Consulta', [
    ...
    createData(2,'Estado actual de salud', [
        { name: 'Nombre', value: 'María Caridad Cáceres Salamea' },
        { name: 'Edad', value: '22' },
        { name: 'Ocupación', value: 'Ingeniera de Sistemas' },
        { name: 'Estado Civil', value: 'Soltera' },
    ...
    createData(3,'Enfermedades Crónicas', [
        { name: 'Nombre', value: 'María Caridad Cáceres Salamea' },
        { name: 'Edad', value: '22' },
        { name: 'Ocupación', value: 'Ingeniera de Sistemas' },
        { name: 'Estado Civil', value: 'Soltera' },
                ...
                <Card className={classes.root}>
                    <TableContainer component={Paper}>
                        <Table aria-label="collapsible table">
                            ...
                            <TableBody>
                                {rows.map((row) => (
                                    <Row onMouseOver={row.verificar} key={row.titulo} row={row} />
                                ))}
                            </TableBody>
                        </Table>
                    </TableContainer>
